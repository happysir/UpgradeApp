...
//	private NetworkListHandler progressHandler;
			...
			try
			{
				...
				if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED))
				{
					...
					do
					{
						...
						System.out.println("9888988888888888888");						
					...
					try
					{
						...
						//	System.out.println("qqqqqq99999999999---------fffffff");						
	...
	/**
	 * Function:
	 * @author dehoo-ZhongHeliang 2013-2-28下午6:30:24
	 * 缓冲区数据
	 */
...
//	
//	// 广播信息
//	private final String DOWNOK_MSG_BROADCAST = "downok_msg_broadcast";
...
//	private MessageDigest md5;
//	private static String hashnumber = null;
//	private static String hashdown = null;
...
//	 * @author dehoo-ZhongHeliang 2013-2-28上午9:58:56
//	 */
//	public DownLoadSoft(Context context) {
//		this.mContext = context;
//	}
//
//	/**
...
//			// 下载完成
//			case DOWNLOAD_FINISH:
//				if (!hashdown.equals(hashnumber)) {
//					if (DEBUG)
//						Log.d(TAG, "hash not the same，don't go to download");
//				} else if (DEBUG)
//					Log.d(TAG, "hash is the same ，can go to download");
//				break;
//			default:
//				break;
//			}
...
//	 * @author dehoo-ZhongHeliang 2013-2-28上午9:58:56
//	 */
//	public void downloadApk(Item item ,NetworkListHandler handler) {
//		this.mNetworkListHandler = handler;
...
//
//	/**
//	 * Function: downloadApkThread 下载文件线程
//	 * 
//	 * @author dehoo-ZhongHeliang 2013-2-28上午9:58:56
//	 */
//	private class downloadApkThread extends Thread {
...
//					sdsize = getFreeSpaceInB(mSavePath);
//					if (DEBUG)
//						Log.d(TAG, "sdcard can be used size ：" + "" + sdsize);
//					// 步骤四：解析XML文件，把version.xml放到网络上，然后获取文件信息，该网页保存了下载信息
...
//
//					// 获取下载文件的hash值
//					hashdown = mDownloadItem.hashnumber;
//					if (DEBUG)
//						Log.d(TAG, "download from netword hash ：" + hashdown);
//					// 步骤五：比较文件和下载文件的大小
//					if (length >= sdsize) {
//						Toast.makeText(mContext, "space not enough，place release space", Toast.LENGTH_LONG).show();
//					}
//					// 断点测试，是否能够连接到正确网站并计算文件大小
//					if (DEBUG)
//						Log.d(TAG, "" + length);
...
//					// 步骤七：下载文件到指定目录
//					File apkFile = new File(mSavePath, mDownloadItem.name);
...
//							// 发送下载广播
//							if (DEBUG){
//								Log.d(TAG, "file path is : " + mSavePath+"/"+mDownloadItem.name);
//								mNetworkListHandler.obtainMessage(MessageModel.CHECK_NETWORK_DOWNLOAD_FILE_TYPE, mSavePath+"/"+mDownloadItem.name).sendToTarget();
//							}
//							break;
//						}
//						
...
//					// 测试hash值
//					if (DEBUG)
//						Log.d(TAG, "count file hashnumber：" + hashnumber);
//				} else {
//					Toast.makeText(mContext, "cannot find sdcard or not permission", Toast.LENGTH_LONG).show();
//				}
//			} catch (MalformedURLException e) {
//				e.printStackTrace();
//			} catch (IOException e) {
...
//		}
//		if (DEBUG)
//			Log.d("get space size", "getFreeSpaceInKB:" + Long.toString(nSDFreeSize) + "KB");
//		return nSDFreeSize;
//	}
//
//	/**
